...
class PostAlertSheet extends StatefulWidget {
  const PostAlertSheet({super.key});
  @override
  State<PostAlertSheet> createState() => _PostAlertSheetState();
}

class _PostAlertSheetState extends State<PostAlertSheet> {
  final _form = GlobalKey<FormState>();
  final _title = TextEditingController();
  final _desc = TextEditingController();
  final _loc = TextEditingController();

  AlertCategory _cat = AlertCategory.crime;
  double? _lat, _lng;
  ...
  Future<void> _submit() async {
    ...
    if (user == null) return;
    final err = await context.read<AlertProvider>().postAlert(
          userId: user.id,
          userName: user.name,
    ...
    if (err == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        ...
        Text(_lat != null
            ? 'Alert posted and pinned on the map!'
            : 'Alert posted.'),
      ])));
    } else {
                ...
                children: [
                  ...
                  Row(children: [
                    Container(
                        ...
                        child: const Icon(Icons.warning_amber_rounded,
                            color: AppTheme.cutRed, size: 22)),
                    const SizedBox(width: 12),
                    const Text('Post Alert',
                        style: TextStyle(
                  ...
                  Wrap(
                    ...
                    children: AlertCategory.values.map((c) {
                      ...
                      return ChoiceChip(
                        ...
                        selectedColor: AppTheme.cutBlue,
                        labelStyle: TextStyle(
                            color: sel ? Colors.white : AppTheme.cutDark,
                  ...
                  if (hasPin) ...[
                    ...
                    Row(children: [
                      ...
                      Expanded(
                          child: Text(
                        'Pin at ${_lat!.toStringAsFixed(5)}, ${_lng!.toStringAsFixed(5)} — will appear on the map',
                        style:
